...
// Unified TOC generator function - used across all components
export const generateTableOfContentsHTML = (toc: string): string => {
...
export default function TableOfContents({ toc, setToc }: any) {
  ...
  const tocHTML = generateTableOfContentsHTML(toc);
